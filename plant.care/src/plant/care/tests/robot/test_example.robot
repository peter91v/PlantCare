...
#
#  $ bin/test -s plant.care -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src plant.care.testing.PLANT_CARE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/plant/care/tests/robot/test_example.robot
#
